...
class Blur(Transform):
    ...
    def __init__(self, sigma, output_sz=None, shift=None):
        ...
        x_coord = [torch.arange(-sz, sz+1, dtype=torch.float32)
...
class RandomAffine(Transform):
    ...
    def __call__(self, image, is_mask=False):
        ...
        t_mat = self._construct_t_mat(
            image.shape[:2], do_flip, theta, shear_values, scale_factors)
